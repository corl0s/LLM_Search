...
contains_data_msg = (
    ...
    'it does contain the data needed to construct an intelligent, correct response. This web PAGE TEXT was'
    'retrieved from a search engine using the SEARCH_QUERY that is also attached to user messages in this'
    'conversation. All user messages in this conversation will have the format of: Xn'
    '   PAGE TEXT: "entire page text from the best search result based off the search snippet." \n'
